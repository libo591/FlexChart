package com.boboeye.basic
{
	...
	public class WebUtils
	{
		...
		*/
		...
		/**
		 * 返回如：www.aaa.com/test
		 */
		public static function get AbsoluteContextUrl():String
		{
			var path:String = WebUtils.PathAndName;
			if(path.lastIndexOf("/")!=0){
				path = path.substring(0,path.lastIndexOf("/"));
			}
			return WebUtils.Protocol+"//"+WebUtils.Host+path;
		}
